...
public class ErosionArea {
    ...
    private static Button prepareDilationButton() {
        ...
        transButton.setText("Zastosuj erozję");
        ...
        transButton.setOnAction(
            new EventHandler<ActionEvent>() {
                ...
                public void handle(final ActionEvent e) {
                    try {
                        BufferedImage bufferedImage = transformer.applyErosion((int) theSlider.getValue());
                        holder.showImage(bufferedImage);
                    } catch (NullPointerException ex) {
                        System.out.println("[APP] Applying erosion before image was set");
                    }
                }
            }
        );
